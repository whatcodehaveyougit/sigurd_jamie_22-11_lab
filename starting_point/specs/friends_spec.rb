...
def test_getting_tv_show
  ...
  def test_food_preference__true
    result = get_food_preference(@person5, "spinach")
    assert_equal(true, result)
  end

  # def test_food_preference__false
  #   result = get_food_preference(@person5, "spinach")
...
def test_add_new_name_to_list_of_friend
  get_add_friend(@person2, 'Scrappy-Doo')
  ...
  def test_remove_name_by_value
    get_remove_friend(@person4, "Shaggy")
  ...
  def test_calculating_money_of_everyone  
    result = adding_money_of_everyone(@people)
